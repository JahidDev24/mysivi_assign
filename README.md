...
git clone [https://github.com/JahidDev24/mysivi_assign.git](https://github.com/JahidDev24/mysivi_assign.git)
...
3. Generate Hive AdaptersSince this project uses Hive for local storage, you must generate the type adapters before running the app.
Bash
